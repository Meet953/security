	...
	public static void main(String[] args) {
		...
		try {
			...
			// get public keys
			 ...
			 X509EncodedKeySpec x509KeySpec1 =
			new X509EncodedKeySpec(publicKey1bytes);
			 PublicKey publicKey1 = keyFact.generatePublic(x509KeySpec1);
			 X509EncodedKeySpec x509KeySpec2 =
			new X509EncodedKeySpec(publicKey2bytes);
